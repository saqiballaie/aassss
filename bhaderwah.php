...
$date= date("d/m/y");
$date1= date("d");
$file=file_get_contents("http://14.139.247.11/citywx/city_weather.php?id=42048");
$file=str_replace('<center>','',$file);
$file=str_replace('Past 24 Hours Weather Data','',$file);
$file=str_replace('img/srinagar.gif','',$file);
$file=str_replace('Local Weather Report and Forecast For:','',$file);
$file=str_replace('<FONT color=blue>Bhaderwah</Font>','============<br>*Bhaderwah*',$file);
...
$file=str_replace('<a href="http://www.imd.gov.in/section/climate/exbreme/bhaderwah2.htm">Exbreme & Climatological Information</a>','',$file);
