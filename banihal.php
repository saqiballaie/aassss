...
$date= date("d/m/y");
$date1= date("d");
$file=file_get_contents("http://14.139.247.11/citywx/city_weather.php?id=42045");
...
$file=str_replace('<FONT color=blue>Banihal</Font>','============<br>*Banihal*',$file);
...
$file=str_replace('<a href="http://www.imd.gov.in/section/climate/exbreme/banihal2.htm">Exbreme & Climatological Information</a>','',$file);
