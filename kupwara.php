...
$date= date("d/m/y");
$date1= date("d");
$file=file_get_contents("http://14.139.247.11/citywx/city_weather.php?id=42031");
$file=str_replace('<center>','',$file);
$file=str_replace('Past 24 Hours Weather Data','',$file);
$file=str_replace('img/kupwara.gif','',$file);
$file=str_replace('Local Weather Report and Forecast For:','',$file);
$file=str_replace('<FONT color=blue>Kupwara</Font>','============<br>*Kupwara*',$file);
...
$file=str_replace('<a href="http://www.imd.gov.in/section/climate/exbreme/kupwara2.htm">Exbreme & Climatological Information</a>','',$file);
