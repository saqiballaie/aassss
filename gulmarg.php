...
$date= date("d/m/y");
$date1= date("d");
$file=file_get_contents("http://14.139.247.11/citywx/city_weather.php?id=42026");
...
$file=str_replace('<FONT color=blue>Gulmarg</Font>','============<br>*Gulmarg*',$file);
...
$file=str_replace('<a href="http://www.imd.gov.in/section/climate/exbreme/gulmarg2.htm">Exbreme & Climatological Information</a>','',$file);
