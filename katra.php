...
$date= date("d/m/y");
$date1= date("d");
$file=file_get_contents("http://14.139.247.11/citywx/city_weather.php?id=42054");
$file=str_replace('<center>','',$file);
$file=str_replace('Past 24 Hours Weather Data','',$file);
$file=str_replace('img/katra.gif','',$file);
$file=str_replace('Local Weather Report and Forecast For:','',$file);
$file=str_replace('tr','br',$file);
$file=str_replace("Kabra","Katra",$file);
$file=str_replace('<FONT color=blue>Katra</Font>','============<br>*Katra*',$file);
...
$file=str_replace('<a href="http://www.imd.gov.in/section/climate/exbreme/kabra2.htm">Exbreme & Climatological Information</a>','',$file);
